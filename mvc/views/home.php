...
<section class="hero-banner">
        <img src="assets/img/hero-banner/hero-banner.png" alt="" />
        <div class="text-container">
          ...
          <div class="btn-decouvrir">
            <a href="catalogue.html"
              ><button class="decouvrir-encheres">
      ...
      <section class="container-timbres">
        ...
        <div class="carrousel">
          ...
          <div class="carrousel__card">
            <div class="carrousel__title"><h2>Titre</h2></div>
            <div class="carrousel__image">
              <a href="produit.html"
                ><img src="assets/img/stamp/san-francisco.webp" alt=""
              /></a>
            </div>
          ...
          <div class="carrousel__card invisible">
            ...
            <div class="carrousel__image">
              <a href="produit.html"
                ><img
                  src="assets/img/stamp/usa.webp"
                  alt="timbre forbidden city"
              /></a>
            </div>
            <div class="carrousel__id">Id:<small>878787878</small></div>
            <div class="carrousel__prix">Offre actuelle: <small>8950$</small></div>
          ...
          <div class="carrousel__card ">
            ...
            <div class="carrousel__image">
              <a href="produit.html"
                ><img
                  src="assets/img/stamp/parthenon.webp"
                  alt="timbre czech-republic"
              /></a>
            </div>
            <div class="carrousel__id">Id:<small>878787878</small></div>
            <div class="carrousel__prix">Offre actuelle:<small>8950$</small></div>
      ...
      <section class="participez-encheres">
        ...
        <div class="decouvrir">
          <img
            src="assets/img/stamp/czech-republic.webp"
            alt="timbre czech-republic"
          />
          <a href="catalogue.html"
            ><button class="decouvrir-encheres">
