...
<section class="hero-banner">
  <img src="{{ asset }}/css/img/hero-banner/hero-banner.png" alt="" />
  ...
  <div class="carrousel">
    ...
    <div class="carrousel__card">
      ...
      <div class="carrousel__image">
        <a href="produit.html"><img src="{{asset}}/css/img/stamp/san-francisco.webp" alt="" /></a>
      </div>
    ...
    <div class="carrousel__card invisible">
      ...
      <div class="carrousel__image">
        <a href="produit.html"><img src="{{asset}}/css/img/stamp/usa.webp" alt="timbre forbidden city" /></a>
      </div>
      <div class="carrousel__id">Id:<small>878787878</small></div>
      <div class="carrousel__prix">Offre actuelle: <small>8950$</small></div>
      <div class="hourglass">
    ...
    <div class="carrousel__card ">
      ...
      <div class="carrousel__image">
        <a href="produit.html"><img src="{{asset}}/css/img/stamp/parthenon.webp" alt="timbre czech-republic" /></a>
      </div>
      <div class="carrousel__id">Id:<small>878787878</small></div>
      <div class="carrousel__prix">Offre actuelle:<small>8950$</small></div>
      <div class="hourglass">
